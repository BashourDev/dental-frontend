...
export const BigFooter = () => {
  ...
  return (
    <div className="px-4 pt-16 mx-auto w-full sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-light">
              {t("ln") === "en"
                ? info?.en_about_us_description
                : info?.ar_about_us_description}
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              className="transition-colors duration-300 text-light hover:text-light-gold"
            >
              {t("ln") === "en" ? info?.en_address : info?.ar_address}
            </a>
          </div>
        </div>
        <div>
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-300">
          © Copyright 2022 Tabibalasnan. All rights reserved.
        </p>
